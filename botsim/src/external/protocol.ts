/*****************************************************************************/
// CONTENT BELOW COPIED FROM <root>/protocol/protocol.ts, and updated for module
// symantics (exporting symbols). Keep this in sync with that file.
/*****************************************************************************/

/**
 * Index of the line detectors
 */
export enum RobotLineDetector {
    /**
     * block="outer left"
     */
    OuterLeft = 0,
