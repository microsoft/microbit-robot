...
makecode -c mkc-kitronikmotordriverv2.json -f size
cp ./built/mbdal-binary.hex ./assets/kitronik-motor-driver-v2-for-microbit-v1.hex
cp ./built/mbcodal-binary.hex ./assets/kitronik-motor-driver-v2-for-microbit-v2.hex
